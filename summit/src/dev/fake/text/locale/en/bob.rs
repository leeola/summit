...
// Compiled by https://www.bobrosslipsum.com 2023 July
const BOB_SENTENCES: [&'static str; 403] = [
    ...
    "All those little son of a guns.",
    ...
    "I'm going to mix up a little color. Well use Van Dyke Brown, Permanent Red, and a little bit of Prussian Blue.",
    "I'm gonna add just a tiny little amount of Prussian Blue.",
    ...
    "It takes dark in order to show light.",
    "It's a good way of getting rid of all your anxieties and hostilities.",
    "It's a super day, so why not make a beautiful sky?",
    "It's a very cold picture, I may have to go get my coat. Its about to freeze me to death.",
    ...
    "Let's just drop a little Evergreen right here.",
    ...
    "They say everything looks better with odd numbers of things. But sometimes I put even numbersjust to upset the critics.",
    ...
    "We'll put a happy little bush here.",
    ...
    "Without washing the brush, I'm gonna go right into some Van Dyke Brown, some Burnt Umber, and a little bit of Sap Green.",
    ...
    "You can bend rivers. But when I get home, the only thing I have power over is the garbage.",
    ...
    "You need to have a very firm paint to do this.",
...
const BOB_SENTENCE_WORDS: [&'static [&'static str]; 403] = [
    &["A", "beautiful", "little", "sunset."],
    &[
        "A", "big", "strong", "tree", "needs", "big", "strong", "roots.",
    ],
    ...
    &[
        "A", "tree", "needs", "to", "be", "your", "friend", "if", "you're", "going", "to", "paint",
        "him.",
    ],
    &[
        "Absolutely",
    ...
    &[
        "All", "you", "need", "is", "a", "dream", "in", "your", "heart,", "and", "an", "almighty",
        "knife.",
    ],
    &[
        "All",
    ...
    &["Be", "brave."],
    &[
        "Be", "careful.", "You", "can", "always", "add", "more", "-", "but", "you", "can't",
        "take", "it", "away.",
    ],
    &[
        "Be", "so", "very", "light.", "Be", "a", "gentle", "whisper.",
    ...
    &[
        "Clouds", "are", "free.", "They", "just", "float", "around", "the", "sky", "all", "day",
        "and", "have", "fun.",
    ],
    &[
        "Decide", "where", "your", "cloud", "lives.", "Maybe", "he", "lives", "right", "in",
        "here.",
    ],
    &[
        "Didn't",
    ...
    &["Don't", "hurry.", "Take", "your", "time", "and", "enjoy."],
    &[
        "Don't", "kill", "all", "your", "dark", "areas", "-", "you", "need", "them", "to", "show",
        "the", "light.",
    ],
    &[
        "Each",
    ...
    &[
        "From", "all", "of", "us", "here,", "I", "want", "to", "wish", "you", "happy", "painting",
    ...
    &[
        "How", "to", "paint.", "That's", "easy.", "What", "to", "paint.", "That's", "much",
        "harder.",
    ],
    &[
        "I",
    ...
    &[
        "I", "guess", "I'm", "a", "little", "weird.", "I", "like", "to", "talk", "to", "trees",
        "and", "animals.", "That's", "okay", "though;", "I", "have", "more", "fun", "than", "most",
        "people.",
    ],
    &[
        "I",
    ...
    &[
        "I", "think", "there's", "an", "artist", "hidden", "in", "the", "bottom", "of", "every",
        "single", "one", "of", "us.",
    ],
    &[
        "I", "thought", "today", "we", "would", "do", "a", "happy", "little", "picture.",
    ...
    &[
        "I", "thought", "today", "we", "would", "make", "a", "happy", "little", "stream", "that's",
        "just", "running", "through", "the", "woods", "here.",
    ],
    &[
        "I", "want", "everbody", "to", "be", "happy.", "That's", "what", "it's", "all", "about.",
    ],
    &[
        "I", "was", "blessed", "with", "a", "very", "steady", "hand;", "and", "it", "comes", "in",
        "very", "handy", "when", "you're", "doing", "these", "little", "delicate", "things.",
    ],
    &[
    ...
    &[
        "I'm", "gonna", "start", "with", "a", "little", "Alizarin", "crimson", "and", "a", "touch",
        "of", "Prussian", "blue",
    ],
    &[
        "I'm", "sort", "of", "a", "softy,", "I", "couldn't", "shoot", "Bambi", "except", "with",
        "a", "camera.",
    ],
    &[
        "If",
    ...
    &[
        "If", "it's", "not", "what", "you", "want", "-", "stop", "and", "change", "it.", "Don't",
    ...
    &[
        "If", "we're", "gonna", "walk", "though", "the", "woods,", "we", "need", "a", "little",
        "path.",
    ],
    &[
        "If", "what", "you're", "doing", "doesn't", "make", "you", "happy", "-", "you're", "doing",
        "the", "wrong", "thing.",
    ],
    &[
        "If", "you", "didn't", "have", "baby", "clouds,", "you", "wouldn't", "have", "big",
        "clouds.",
    ],
    &[
        "If",
    ...
    &[
        "If", "you", "don't", "think", "every", "day", "is", "a", "good", "day", "-", "try",
        "missing", "a", "few.", "You'll", "see.",
    ],
    &["If", "you", "hypnotize", "it,", "it", "will", "go", "away."],
    &[
        "If", "you", "overwork", "it", "you", "become", "a", "cloud", "killer.", "There's",
    ...
    &["It", "is", "a", "lot", "of", "fun."],
    &[
        "It", "just", "happens", "-", "whether", "or", "not", "you", "worried", "about", "it",
        "or", "tried", "to", "plan", "it.",
    ],
    &[
        "It", "looks", "so", "good,", "I", "might", "as", "well", "not", "stop.",
    ...
    &[
        "It's", "a", "very", "cold", "picture,", "I", "may", "have", "to", "go", "get", "my",
        "coat.", "Its", "about", "to", "freeze", "me", "to", "death.",
    ],
    &["It's", "all", "a", "game", "of", "angles."],
    &[
        "It's",
    ...
    &[
        "It's", "amazing", "what", "you", "can", "do", "with", "a", "little", "love", "in", "your",
        "heart.",
    ],
    &[
        "It's",
    ...
    &["It's", "cold,", "but", "it's", "beautiful."],
    &[
        "It's", "hard", "to", "see", "things", "when", "you're", "too", "close.", "Take", "a",
        "step", "back", "and", "look.",
    ],
    &["It's", "important", "to", "me", "that", "you're", "happy."],
    &["It's", "life.", "It's", "interesting.", "It's", "fun."],
    ...
    &[
        "Just", "let", "this", "happen.", "We", "just", "let", "this", "flow", "right", "out",
        "of", "our", "minds.",
    ],
    &[
        "Just", "let", "your", "mind", "wander", "and", "enjoy.", "This", "should", "make", "you",
        "happy.",
    ],
    &["Just", "make", "a", "decision", "and", "let", "it", "go."],
    &["Just", "make", "little", "strokes", "like", "that."],
    ...
    &[
        "Just", "think", "about", "these", "things", "in", "your", "mind", "-", "then", "bring",
        "them", "into", "your", "world.",
    ],
    &[
        "Just", "think", "about", "these", "things", "in", "your", "mind", "and", "drop", "em'",
        "on", "canvas.",
    ],
    &["Just", "use", "the", "old", "one", "inch", "brush."],
    &["La-", "da-", "da-", "da-", "dah.", "Just", "be", "happy."],
    &["Learn", "when", "to", "stop."],
    &[
        "Let", "all", "these", "little", "things", "happen.", "Don't", "fight", "them.", "Learn",
        "to", "use", "them.",
    ],
    &[
        "Let", "all", "these", "things", "just", "sort", "of", "happen.",
    ...
    &[
        ...
        "maybe", "one", "day", "he", "went", "to", "check", "his", "beaver", "traps,", "and",
        "maybe", "he", "fell", "into", "the", "river", "and", "drowned.",
    ],
    &[
        "Maybe",
        "there's",
    ...
    &[
        "Maybe,", "just", "to", "play", "a", "little,", "we'll", "put", "a", "little", "tree",
        "here.",
    ],
    &[
        "Mix", "your", "color", "marbly", "don't", "mix", "it", "dead.",
    ...
    &[
        "Nice", "little", "fluffy", "clouds", "laying", "around", "in", "the", "sky", "being",
        "lazy.",
    ],
    &[
        "No",
    ...
    &[
        "No", "worries.", "No", "cares.", "Just", "float", "and", "wait", "for", "the", "wind",
        "to", "blow", "you", "around.",
    ],
    &["Nothing", "wrong", "with", "washing", "your", "brush."],
    &[
    ...
    &[
        "Now", "we", "don't", "want", "him", "to", "get", "lonely,", "so", "we'll", "give", "him",
        "a", "little", "friend.",
    ],
    &["Now", "we'll", "take", "the", "almighty", "fan", "brush."],
    &["Now,", "we're", "going", "to", "fluff", "this", "cloud."],
    &[
        "Of", "course", "he's", "a", "happy", "little", "stone,", "cause", "we", "don't", "have",
        "any", "other", "kind.",
    ],
    &[
        "Once",
    ...
    &["Poor", "old", "tree."],
    &[
        "Pretend", "you're", "water.", "Just", "floating", "without", "any", "effort.", "Having",
        "a", "good", "day.",
    ],
    &["Put", "it", "in,", "leave", "it", "alone."],
    &[
        "Put", "light", "against", "light", "-", "you", "have", "nothing.", "Put", "dark",
        "against", "dark", "-", "you", "have", "nothing.", "It's", "the", "contrast", "of",
        "light", "and", "dark", "that", "each", "give", "the", "other", "one", "meaning.",
    ],
    &[
        "Put", "your", "feelings", "into", "it,", "your", "heart,", "it's", "your", "world.",
    ],
    &[
        "Remember", "how", "free", "clouds", "are.", "They", "just", "lay", "around", "in", "the",
        "sky", "all", "day", "long.",
    ],
    &[
        "See", "how", "easy", "it", "is", "to", "create", "a", "little", "tree", "right", "in",
        "your", "world.",
    ],
    &["See", "there", "how", "easy", "that", "is."],
    &[
    ...
    &[
        "So", "often", "we", "avoid", "running", "water,", "and", "running", "water", "is", "a",
        "lot", "of", "fun.",
    ],
    &[
        "Sometimes",
    ...
    &["That's", "crazy."],
    &[
        "That's", "the", "way", "I", "look", "when", "I", "get", "home", "late;", "black", "and",
        "blue.",
    ],
    &[
        "That's",
    ...
    &[
        "That's", "what", "painting", "is", "all", "about.", "It", "should", "make", "you", "feel",
        "good", "when", "you", "paint.",
    ],
    &[
        "That's", "why", "I", "paint", "-", "because", "I", "can", "create", "the", "kind", "of",
        "world", "I", "want", "-", "and", "I", "can", "make", "this", "world", "as", "happy", "as",
        "I", "want", "it.",
    ],
    &[
        "The", "first", "step", "to", "doing", "anything", "is", "to", "believe", "you", "can",
        "do", "it.", "See", "it", "finished", "in", "your", "mind", "before", "you", "ever",
        "start.",
    ],
    &["The", "least", "little", "bit", "can", "do", "so", "much."],
    &["The", "light", "is", "your", "friend.", "Preserve", "it."],
    ...
    &[
        "The", "man", "who", "does", "the", "best", "job", "is", "the", "one", "who", "is",
        "happy", "at", "his", "job.",
    ],
    &[
        "The", "more", "we", "do", "this", "-", "the", "more", "it", "will", "do", "good",
        "things", "to", "our", "heart.",
    ],
    &[
        "The",
    ...
    &[
        "There", "is", "no", "right", "or", "wrong", "-", "as", "long", "as", "it", "makes", "you",
        "happy", "and", "doesn't", "hurt", "anyone.",
    ],
    &[
        "There", "isn't", "a", "rule.", "You", "just", "practice", "and", "find", "out", "which",
    ...
    &["There", "we", "go."],
    &[
        "There's", "not", "a", "thing", "in", "the", "world", "wrong", "with", "washing", "your",
        "brush.",
    ],
    &[
        "There's", "nothing", "wrong", "with", "having", "a", "tree", "as", "a", "friend.",
    ...
    &[
        "These", "little", "son", "of", "a", "guns", "hide", "in", "your", "brush", "and", "you",
        "just", "have", "to", "push", "them", "out.",
    ],
    &[
        "These",
        "things",
    ...
    &[
        "This", "is", "probably", "the", "greatest", "thing", "that's", "ever", "happened", "in",
        "my", "life.",
    ],
    &[
    ...
    &[
        "This", "is", "your", "creation", "-", "and", "it's", "just", "as", "unique", "and",
        "special", "as", "you", "are.",
    ],
    &[
        "This", "is", "your", "world,", "whatever", "makes", "you", "happy", "you", "can", "put",
        "in", "it.", "Go", "crazy.",
    ],
    &["This", "is", "your", "world."],
    &[
    ...
    &[
        "Trees", "live", "in", "your", "fan", "brush,", "but", "you", "have", "to", "scare",
        "them", "out.",
    ],
    &[
        "Use",
    ...
    &[
        "We", "can", "always", "carry", "this", "a", "step", "further.", "There's", "really", "no",
        "end", "to", "this.",
    ],
    &["We", "can", "fix", "anything."],
    &[
    ...
    &[
        "We", "start", "with", "a", "vision", "in", "our", "heart,", "and", "we", "put", "it",
        "on", "canvas.",
    ],
    &[
        "We",
    ...
    &[
        "We", "want", "to", "use", "a", "lot", "pressure", "while", "using", "no", "pressure",
        "at", "all.",
    ],
    &["We", "wash", "our", "brush", "with", "odorless", "thinner."],
    &["We'll", "do", "another", "happy", "little", "painting."],
    ...
    &["We'll", "put", "a", "happy", "little", "sky", "in", "here."],
    &[
        "We'll", "put", "all", "the", "little", "clouds", "in", "and", "let", "them", "dance",
        "around", "and", "have", "fun.",
    ],
    &[
        "We'll", "put", "some", "happy", "little", "leaves", "here", "and", "there.",
    ...
    &[
        "When", "you", "buy", "that", "first", "tube", "of", "paint", "it", "gives", "you", "an",
        "artist", "license.",
    ],
    &[
        "When", "you", "do", "it", "your", "way", "you", "can", "go", "anywhere", "you", "choose.",
    ...
    &[
        "Without", "washing", "the", "brush,", "I'm", "gonna", "go", "right", "into", "some",
        "Van", "Dyke", "Brown,", "some", "Burnt", "Umber,", "and", "a", "little", "bit", "of",
        "Sap", "Green.",
    ],
    &[
        "Work", "on", "one", "thing", "at", "a", "time.", "Don't", "get", "carried", "away", "-",
    ...
    &[
        "You", "can", "bend", "rivers.", "But", "when", "I", "get", "home,", "the", "only",
        "thing", "I", "have", "power", "over", "is", "the", "garbage.",
    ],
    &[
        "You", "can", "create", "anything", "that", "makes", "you", "happy.",
    ],
    ...
    &[
        "You", "can", "create", "the", "world", "you", "want", "to", "see", "and", "be", "a",
        "part", "of.", "You", "have", "that", "power.",
    ],
    &[
        "You",
        "can",
    ...
    &[
        "You", "can", "work", "and", "carry-on", "and", "put", "lots", "of", "little", "happy",
        "things", "in", "here.",
    ],
    &[
        "You",
    ...
    &[
        "You", "could", "sit", "here", "for", "weeks", "with", "your", "one", "hair", "brush",
        "trying", "to", "do", "that", "-", "or", "you", "could", "do", "it", "with", "one",
        "stroke", "with", "an", "almighty", "brush.",
    ],
    &[
        "You", "create", "the", "dream", "-", "then", "you", "bring", "it", "into", "your",
        "world.",
    ],
    &[
        "You", "don't", "have", "to", "be", "crazy", "to", "do", "this", "but", "it", "does",
        "help.",
    ],
    &[
        "You", "don't", "have", "to", "spend", "all", "your", "time", "thinking", "about", "what",
        "you're", "doing,", "you", "just", "let", "it", "happen.",
    ],
    &[
        "You",
        "don't",
    ...
    &["You're", "meant", "to", "have", "fun", "in", "life."],
    &[
        "You're", "the", "greatest", "thing", "that", "has", "ever", "been", "or", "ever", "will",
